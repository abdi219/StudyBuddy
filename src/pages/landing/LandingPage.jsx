...
/* ─── Platform Features (not GPA-only!) ─── */
const features = [
  {
    icon: GraduationCap,
    title: "Smart GPA Tracking",
    desc: "Calculate GPA across 4.0, 5.0, and 10.0 scales. Track semester and overall performance with weighted averages.",
    color: "#5b5bd6",
  },
  {
    icon: CalendarDays,
    title: "Study Planner",
    desc: "Plan your study week with visual timetables. Color-code subjects and never miss a deadline again.",
    color: "#2d9d78",
  },
  {
    icon: Clock,
    title: "Pomodoro Timer",
    desc: "Stay focused with timed study sessions. Track your productivity streaks and build better habits.",
    color: "#e5a31d",
  },
  {
    icon: PenTool,
    title: "Interactive Classroom",
    desc: "All-in-one workspace with notes, drawing board, video player, AI assistant, and code editor.",
    color: "#d14343",
  },
  {
    icon: Brain,
    title: "AI Study Assistant",
    desc: "Get instant help with concepts, summaries, and practice questions. Your personal tutor, available 24/7.",
    color: "#3e8ed0",
  },
  {
    icon: Target,
    title: "Progress Analytics",
    desc: "Visualize your study patterns. See weekly trends, subject breakdowns, and performance insights.",
    color: "#9333ea",
  },
];
...
const tools = [
  {
    icon: GraduationCap,
    title: "GPA Analyzer",
    desc: "Multi-scale grading with real-time calculations and weighted averages.",
    to: "/gpa",
  },
  {
    icon: Repeat,
    title: "ScaleFlex",
    desc: "Switch between 4.0, 5.0, and 10.0 grading scales dynamically.",
    to: "/gpa/calculate",
  },
  {
    icon: Scale,
    title: "Convertify",
    desc: "Smart GPA converter for global compatibility and applications abroad.",
    to: "/gpa",
  },
];
  ...
  return (
    <div style={{ background: "var(--bg-base)", minHeight: "100vh", position: "relative" }}>
      ...
      <nav style={{
        ...
        <div style={{
          width: "100%", maxWidth: 1200, padding: "0 24px",
      ...
      <section id="hero" style={{
        ...
        <StudentDoodles count={12} opacity={0.06} seed={42} />
        ...
        <div style={{
          ...
          <div style={{ flex: "1 1 520px", minWidth: 0 }}>
            <div className="doodle-chip" style={{ marginBottom: 20 }}>
            ...
            <h1 style={{
              ...
              <span style={{ color: "var(--accent)", position: "relative", display: "inline-block" }}>
                ...
                <PencilDrawLine
                  ...
                  color="var(--accent)" duration={1.5} delay={0.5}
                  style={{ position: "absolute", bottom: -6, left: 0, width: "100%", opacity: 0.4 }}
                />
              </span>
            </h1>
            ...
            <p style={{
              ...
              maxWidth: 500, marginBottom: 32, marginTop: 16,
            }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 14, marginBottom: 40 }}>
              ...
              <Link to="/classroom" className="btn btn-secondary">
                Explore Classroom
              </Link>
            </div>
          ...
          <div style={{ flex: "0 0 auto", display: "flex", justifyContent: "center", position: "relative" }}>
            {/* Doodle ring around image */}
            <div style={{
              width: 240, height: 240, borderRadius: "50%", padding: 6,
              border: "3px dashed var(--doodle-strong)", background: "var(--accent-soft)",
              animation: "doodleFloat 6s ease-in-out infinite", position: "relative",
            }}>
              <img src="/abdi.jpg" alt="Abdullah Faisal" style={{
                width: "100%", height: "100%", borderRadius: "50%", objectFit: "cover",
              }} />
            </div>
            {/* Floating doodle accents around image */}
            <div style={{ position: "absolute", top: -15, right: -15, fontSize: 22, opacity: 0.15, animation: "doodleFloat 5s ease-in-out infinite" }}>📐</div>
            <div style={{ position: "absolute", bottom: -10, left: -20, fontSize: 20, opacity: 0.12, animation: "doodleFloat 7s ease-in-out infinite 1s" }}>✏️</div>
            <div style={{ position: "absolute", top: 50, right: -30, fontSize: 18, opacity: 0.1, animation: "doodleFloat 8s ease-in-out infinite 2s" }}>📚</div>
          </div>
        </div>
      </section>
      ...
      <section id="features" style={{
        background: "var(--bg-surface)", borderTop: "1px solid var(--border-light)", position: "relative",
      }}>
        <StudentDoodles count={6} opacity={0.04} seed={99} />
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "80px 24px", position: "relative", zIndex: 1 }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            }}>Built for the modern student</h2>
            <p style={{
              fontSize: 15, color: "var(--text-secondary)", maxWidth: 550, margin: "0 auto", lineHeight: 1.7,
            }}>
            ...
            {features.map((f, i) => (
              <div
                ...
                style={{
                  ...
                  border: hoveredFeature === i ? `1.5px solid ${f.color}30` : "1px solid var(--border)",
                  borderRadius: "var(--radius-lg)", padding: 28,
                  transition: "all 0.35s cubic-bezier(0.34, 1.56, 0.64, 1)",
                  cursor: "default", position: "relative", overflow: "hidden",
                  transform: hoveredFeature === i ? "translateY(-4px) rotate(-0.5deg)" : "none",
                  boxShadow: hoveredFeature === i ? `0 12px 32px ${f.color}15` : "var(--shadow-sm)",
                }}
              ...
              >
                <div style={{
                  ...
                  background: `${f.color}12`, border: `1.5px solid ${f.color}25`,
                  display: "flex", alignItems: "center", justifyContent: "center",
      ...
      {/* ████████████████████████████████████
         TOOLS SECTION
         ████████████████████████████████████ */}
      <section id="tools" className="notebook-bg" style={{
        borderTop: "1px solid var(--border-light)", position: "relative",
      }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "80px 24px", position: "relative", zIndex: 1 }}>
          <div style={{ marginBottom: 48 }}>
            ...
            <h2 style={{
              ...
              fontFamily: "'Space Grotesk', sans-serif",
            }}>Powerful tools, zero complexity</h2>
            <p style={{ fontSize: 15, lineHeight: 1.75, color: "var(--text-secondary)", maxWidth: 550 }}>
              Each tool is built to be intuitive, accurate, and fast. Jump in and start using them right away.
            </p>
          </div>
      ...
      <section id="about" style={{
        ...
        <StudentDoodles count={5} opacity={0.04} seed={77} />
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "80px 24px", position: "relative", zIndex: 1 }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <h2 style={{
              ...
              fontFamily: "'Space Grotesk', sans-serif",
            }}>Built by a student, for students</h2>
          </div>

          <div style={{
            background: "var(--bg-base)", border: "1px solid var(--border)",
            borderRadius: "var(--radius-xl)", padding: 44,
            boxShadow: "var(--shadow-md)", maxWidth: 900, margin: "0 auto",
          }}>
            <div style={{
              ...
              <div style={{ flex: "1 1 400px", minWidth: 0 }}>
                <p style={{ fontSize: 16, lineHeight: 1.85, color: "var(--text-secondary)", marginBottom: 18 }}>
                  ...
                  at <strong style={{ color: "var(--text-primary)" }}>Lahore Garrison University</strong>. I'm passionate about
                  building tools that make student life easier and more organized.
                </p>
                <p style={{ fontSize: 16, lineHeight: 1.85, color: "var(--text-secondary)", marginBottom: 18 }}>
                ...
                <p style={{ fontSize: 15, lineHeight: 1.8, color: "var(--accent)", fontWeight: 500 }}>
              ...
              <div style={{
                ...
                <div style={{
                  width: 180, height: 180, borderRadius: 20, padding: 4,
                  border: "2.5px dashed var(--border-accent)", background: "var(--accent-soft)",
